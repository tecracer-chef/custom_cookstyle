Gem::Specification.new do |spec|
  spec.name        = 'custom_cookstyle'
  spec.version     = '0.0.1'
  spec.license     = 'Apache-2.0'

  spec.summary     = 'Placeholder for customer-specific Chef Cookstyle rules'
  spec.description = 'No functionality'
  spec.authors     = ['tecRacer Opensource']
  spec.email       = ['opensource@tecracer.de']
  spec.homepage    = 'https://github.com/tecracer-chef/custom_cookstyle'
  ...
  spec.post_install_message = <<~MESSAGE
    ...
    customized Cookstyle gem into your internal RubyGems repository yet.
  MESSAGE
end
